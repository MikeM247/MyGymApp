...
5. Use `Edit Muscles` on any exercise to override the auto-detected muscle groups (or use `Auto Detect` to reset).
6. Tap `Complete Exercise` when done (includes a small celebration animation), then save your session to history.
7. Review analytics:
